            ...
            <div className="blog-box box-shadow rounded p-3 mt-4">
              ...
              <Media className="mt-4">
                <div className="blog-date rounded">
                  <h5 className="text-white f-14 font-weight-normal p-2 mb-0">
                    {blog.date}
                  </h5>
                  <h5 className="f-12 font-weight-normal rounded text-white p-2 mb-0 text-uppercase">
                    {blog.month}
                  </h5>
                </div>
                <Media body className="ml-3 mt-2">
                  <Link to="">
                    <h5 className="f-18 mb-1">{blog.title}</h5>
                  </Link>
